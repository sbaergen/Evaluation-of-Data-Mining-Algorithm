...
public class InputParserParser extends Parser {
	...
	public static class ParseContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InputParserVisitor ) return ((InputParserVisitor<? extends T>)visitor).visitParse(this);
	...
	public static class FileContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InputParserVisitor ) return ((InputParserVisitor<? extends T>)visitor).visitFile(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BeginningContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InputParserVisitor ) return ((InputParserVisitor<? extends T>)visitor).visitBeginning(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExponentialContext extends DistParamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InputParserVisitor ) return ((InputParserVisitor<? extends T>)visitor).visitExponential(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class GaussianContext extends DistParamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InputParserVisitor ) return ((InputParserVisitor<? extends T>)visitor).visitGaussian(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PoissonContext extends DistParamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InputParserVisitor ) return ((InputParserVisitor<? extends T>)visitor).visitPoisson(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class UniformContext extends DistParamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InputParserVisitor ) return ((InputParserVisitor<? extends T>)visitor).visitUniform(this);
			else return visitor.visitChildren(this);
		}
	}
