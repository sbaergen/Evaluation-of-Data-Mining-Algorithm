...
public class Main {
     ...
     */
    public void createGraph(Vector<String> params, Vector<EFG> data) {
        int nodePosition;
        ...
        addEFG(numEFG, data); // Create EFGs with number of nodes,
     ...
     */
    public void addEFG(int numEFG, Vector<EFG> data){
     ...
     */
    public void addEdges(EFG efg, double edgeProb, boolean patterns){
        ...
        for (int i = 1; i < efg.getSize()-1; i++) {
            node = efg.getNodes().get(i);
            for (int j = i; j < (numNodes = efg.getSize() - 1); j++) {
