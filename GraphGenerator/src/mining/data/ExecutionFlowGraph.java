...
public class ExecutionFlowGraph {
	 ...
	 */
	public double getMinAttrWeight(Integer idx) {
	 ...
	 */
	public EFGEdge hasEdge(Integer fromVertexId, Integer toVertexId) {
	...
	public void setNonDiscardableNode(Integer vertexId) {
