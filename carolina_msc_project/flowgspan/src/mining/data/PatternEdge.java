...
public class PatternEdge {
	 ...
	 */
	public PatternEdge(PatternVertex from, PatternVertex to, double frequency) {
		this.from = from;
		this.to = to;
	 ...
	 * @return From-node.
	 */
	public PatternVertex getFromVertex() {
		return from;
	}
	/**
	 ...
	 * @return To-node.
	 */
	public PatternVertex getToVertex() {
		return to;
	}
	...
	public boolean equals(Object edgeObj) {
		PatternEdge e = (PatternEdge)edgeObj;
	...
	public String toMapping(int instanceIdx) {
		String str = "( " + "[ " + from.toMapping(instanceIdx) + " ], " + "[ " + to.toMapping(instanceIdx) + " ] )";
		return str;
	}
}
